...
export function configurationMessage() {
  return 'Management is not configured yet. Add the Supabase project URL and publishable key in management/js/config.mjs, then apply every migration in supabase/migrations in filename order.';
}

...
Validation evidence for the current release is stored under `proof/lichess-50000-*.md` and `proof/logs/lichess-50000-*.txt`.
...
Only a small active shard is loaded into memory. Expanding the library therefore increases static data size without requiring all 50,000 records to be downloaded at trainer startup.

...
When the selected move has siblings and is not currently preferred, the notation area shows **Make main line**. Main-line moves display a status badge instead of a promotion button. Main-line moves display a status badge instead of a promotion button. Main-line moves display a status badge instead of a promotion button.

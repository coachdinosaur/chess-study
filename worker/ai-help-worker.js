...
function buildSystemInstruction(contextJson) {
  return [
    ...
    'Keep ordinary answers compact, usually two to six short paragraphs or steps.',
    'Always finish the answer. Never end with an unfinished lead-in such as "Here is how" or a dangling list introduction.',

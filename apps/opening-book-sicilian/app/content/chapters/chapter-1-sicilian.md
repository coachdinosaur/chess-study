...
* **1.e4 c5**
    ...
    * **B) 2.c4** *(page 9)* [7]
    * **C) 2.Ne2** *(page 11)* [12]
    * **D) 2.Na3 Nc6** *(page 13)* [17]
        * **D1) 3.Bb5** *(page 13)* [18]
        * **D2) 3.Nf3** *(page 14)* [21]
    * **E) 2.f4 g6 3.d4!? cxd4 4.Qxd4 Nf6 5.e5 Nc6** *(page 15)* [25]
        * **E1) 6.Qd1 Ne4!?** *(page 16)* [26]
            * **E11) 7.Nd2** *(page 16)* [27]
            * **E12) 7.Be3** *(page 18)* [32]
        * **E2) 6.Qd3** *(page 19)* [35]
    * **F) 2.a3 g6! 3.b4 Bg7** *(page 20)* [39]
        * **F1) 4.c3?!** *(page 21)* [40]
        * **F2) 4.Nc3!** *(page 22)* [42]
...
**15...Bf5 16.Bh1 Rb8 17.Rd2 Bxc3 18.bxc3 Ne5 19.Qxa7 Qxc3 20.Qd4 Qxd4 21.Rxd4 Nc6 22.Rd2±**
...
*Saule – Jemec*, email 2006, continued with **4.Nf3**, and here I would like to suggest a new idea:

**4...Nge7!N 5.Nc4 (5.0-0 a6 6.Be2 d5 7.exd5 Nxd5 8.Re1 f6 9.Bf1 Be7∓** looks quite unimpressive for White) **5...d6 6.Ne3 a6 7.Be2 d5 8.d3 d4 9.Nc4 Ng6 10.a4 Be6∓** The position is simply excellent for Black.
...
**17.Qf3 Be5 18.0-0 g4 19.Qe2 h5 20.b4 cxb4 21.Rb1 a5 22.cxb4 axb4 23.Bb2 Ra5! 24.Bc3 Bxc3 25.dxc3 Re5 26.Qd2 h4! 27.Rxb4 Qc6 28.Re1**
...
**8...d6! 9.exd6 Bg7 10.Nf3!**

**10.dxe7?! Qxe7+ 11.Be2 (11.Qe3 Be6!∓** leaves White terribly exposed, as he is seriously lagging in development.) **11...0-0 12.Nf3 Bf5!↑** Black has a tremendous initiative for the pawn.

**10...0-0 11.Bc4 Qb6! 12.c3!?**
...
Trying to exploit the active e4-knight by opening up the position. White now faces a struggle to keep the balance [32].

* **7...d5** leads to more static play, although Black should basically be okay; the move **...f6** can perhaps be employed at some point to liquidate the annoying e5-pawn. **8.Bd3 (8.Nf3!? Bg4 9.Be2 Bg7 10.0-0 0-0 11.Nbd2 Nxd2 12.Qxd2 Qa5!? 13.c3!? [13.Qxa5 Nxa5=] 13...e6∞)** [32, 33].
* **8...Qa5+** (Note: **8...Bf5 9.Nf3 Bg7 10.0-0 0-0 11.Nbd2 Qc7=**) **9.c3 Bg7 10.Nf3 10...f6!? 11.exf6?! (11.0-0!? 0-0 12.b4! Qc7 13.Qb3!± e.g., 13...e6 14.Nxe4! dxe4 15.exf6 Bxf6 16.Nfd2)** [33].
* **11...Nxf6 12.Nbd2 Qc7 13.Nb3 0-0 14.Bb5 Nh5 15.Qe2 Ng4! 16.Bd2 e5 17.h3 Nf6 18.Bxc6 bxc6 19.fxe5 Ne4 20.Qe3 Ba6∓** Black was better in *Damljanovic – Z. Arsovic*, Belgrade 1995 [33, 34].

**8.Bd3!?**

Intriguing, but Black still comes out on top [34].

* Weaker is **8.Qd5?! Bf5 9.Bb5 Rc8∓** when White will be pushed back [34].
* After **8.Nf3?! Qa5+! 9.c3 dxe5 10.fxe5 Bg7** the e5-pawn looks fatally exposed. **11.b4?! (White is also worse after 11.Bd3 Nc5 12.Bc4 e6) 11...Qc7 12.Bd3 Bf5!** White is in big trouble. For example: **13.Qc2 (or 13.g4 0-0-0!! 14.gxf5 Nxe5-+** and White is about to be massacred along the open lines) **13...Nxc3!! 14.Qxc3 (14.Nxc3 Nxe5 15.Bxf5 Nxf3+ 16.gxf3 Qxc3+ 17.Kf2 gxf5-+) 14...Bxd3 15.Qxd3 Nxe5 16.Qb5+ Nd7 17.Rd4 Bxd4 18.Bxd4 Rc1+ 19.Be2 Qxh1 20.Bxh8 Qxg2∓** [34].
## Page 19

* Finally, Black also ends up slightly better after: **8.Qf3 f5! 9.exf6 Nxf6 10.Nc3 Bg7 11.h3 (11.Bc4 Bg4! 12.Qg3 d5 13.Be2 Bf5∓ is harmonious for Black) 11...0-0∓** [35].

**8...Qa5+ 9.c3 Qd5! 10.Na3!?**

**10...Nc5!** (Alternatively: **10...Bf5?! 11.Bc2!±**) [35].

**11.Bxc5** (**11.Bf1!?** might be a better chance) [35].

**11...Qxc5 12.Nb5 Rb8∓** Black is for preference [35].
...
White is trying to justify the queen sortie [35].

**6...Nh5!?**

The knight is safely placed on the rim here: it is important not to lose time by retreating it to g8 [35, 36].

**7.Be2**

An attempt to exploit the knight's placement [36].

* **7.Nf3 d6!** White has problems containing Black's activity. **8.Nc3 (8.exd6 Bf5! 9.dxe7?! Qxe7+ 10.Qe3 0-0-0 11.Be2 Qxe3 12.Bxe3 Bg7 13.c3 Rhe8 14.Kf2 Nf6∓) 8...Bg7 9.exd6 (9.Be3?! Bf5 10.Qb5 dxe5 11.Nxe5 0-0 12.Rd1 Qb8!∓** with the idea **13.Nd7 Bxd7 14.Rxd7 Nxf4! 15.Rxb7 Qd6 16.Bxf4 Qxf4 17.Qxc6 Bxc3+ 18.bxc3 Rfd8! 19.Rd7 Rab8-+) 9...Bf5!?** Disturbing the coordination of White's forces. (**9...0-0 10.Be3 Bf5 11.Qd2∞** and White breathes a lot easier.) [36, 37].
* **10.dxe7 Qxe7+ 11.Qe3 Nb4!? (11...Qxe3+ 12.Bxe3 0-0-0 13.Kf2 Rhe8 14.Bb5∞)** [37].
* **12.Bb5+ Kf8 13.Qxe7+ Kxe7 14.0-0 Nxc2 15.Rb1 Nd4 16.Ra1 Rhd8∓**
## Page 20

*Alternatively:* **13.Ba4 Bxc2!** or **13.Kf2 Nxc2 14.Qxe7+ Kxe7 15.Rb1 Nd4 16.Ra1 Rhd8∓** [37].

**7...d6!**

Black ignores White's threat, as **...Bf5** will gain even more time [37, 38].

**8.Bxh5 Bf5 9.Qb3**

The solid choice [38].

* After **9.Qb5 gxh5 10.exd6 (10.Qxb7 Be4!** yields tremendous compensation for the pawn) **10...Qd7! 11.Nf3 (11.dxe7?! Bxe7 12.Nf3 0-0-0 13.0-0 Bxc2 14.Qxh5 Bg6! 15.Qh6 Rhg8-+) 11...e6!?∓** Black stands well [38].

**9...gxh5 10.Nf3 Bg7!?N**

It seems more to the point to concentrate on development rather than lose time defending the pawn [38].

* **10...Qd7 11.0-0 e6∞** happened in *Westerinen – Arnason*, Brighton 1981 [38].

**11.Qxb7!?**

* **11.0-0 dxe5 12.fxe5 (12.Qxb7 Nd4!∓** exchanges White's good knight on f3, giving Black the better prospects.) **12...Nxe5 13.Nxe5 Qd4+ 14.Kh1 Qxe5 15.Nc3 0-0 16.Qxb7 (16.Bf4 Qc5!∓) 16...e6∓** Black is fine in view of his two bishops [39].

**11...Rc8≡**

Black has excellent compensation in return for the pawn [39].
...
White prepares b2-b4, with the idea of attacking the pawn on c5. If Black then replies with ...cxb4, that helps White achieve a central pawn preponderance. However, in practice things are not simple [39].

**2...g6!**

It is a traditional idea to meet similar flank attacks by fianchettoing the king's bishop [40].

**3.b4 Bg7**

We will check the dubious **F1) 4.c3?!** before moving on to the main line with **F2) 4.Nc3!** [40].
...
This impedes the knight's development and weakens the light-square complex in the centre [40].

**4...d5! 5.exd5 Qxd5 6.Nf3 Nf6 7.Be2 0-0**

Black is threatening **...c4**, so White's response is practically forced [40].
...
* **11.Qb3?** White is preparing Rd1 followed by d2-d4, but it proves too slow. **11...Nc6! 12.bxc5 (12.Rd1 e5! 13.Nxe5 Nd4∓) 12...Na5 13.Qc2 bxc5 14.d3 Nh5! 15.Bxg7 Nxg7 16.Nbd2 Ne6 17.Rab1 Qc7 18.Rfe1 Nc6 19.Nb3 a5!∓**. Black went on to win a model game in *Mamedyarov – Kotronias*, Calvia (ol) 2004 [41].

**11...cxd4 12.Nxd4**

* **12.Bxd4 Nc6 13.Bb2 Qxd1 14.Rxd1 Ne4! 15.Bxg7 Kxg7∓** [41].

**12...Ne4**

White has made too many pawn moves, which allows Black's better-developed army to take the leading role in the proceedings [41, 42].

**13.Bf3 Qd7! 14.Qd3 Nc6! 15.Bxe4**

* **15.Qxe4 Nxd4 16.Qxb7 Nxf3+ 17.Qxf3 Bxb2 18.Ra2 Be5∓** [42].

**15...Nxd4 16.Nc3**

* **16.Bxb7 Qxb7 17.Bxd4? Rfd8!** [42].

## Page 22

**16...Bxe4 17.Qxe4**

* **17.Nxe4 Rfd8 18.c5 Qg4!∓** [42].

**17...Qe6 18.Qxe6 Nxe6∓** [42].
...
The critical move: White intends to bring the rook to b1, support the pawn on b4, and thus complete the Bayonet Attack set-up. White will then try to develop the kingside, either by Bc4 and Nf3, or with a fianchetto of the king's bishop [42].

**4...b6!**

The most solid move available to Black, maintaining the central equilibrium [42, 43].

**5.Nf3**

* After **5.g3 Nc6 6.Rb1 e6! (6...d6 7.Bg2 e5 8.Nge2 Nge7 9.0-0 0-0 10.d3 Nd4 11.bxc5 bxc5 12.f4 Be6 13.f5! gxf5 14.exf5 Nexf5 15.Nxd4 cxd4 16.Bxa8 Qxa8 17.Ne4± is what White is hoping for) 7.Bg2 Nge7 8.Nge2 0-0 9.0-0 d5∓** Black may well be slightly better already [43].

**5...Nc6 6.Bb2!?N**

Probably the best way to sacrifice the b4-pawn [43].

* On **6.Rb1**, holding on to the pawn, the best reply is: **6...Nf6! 7.bxc5 (7.b5 Nd4 8.e5 Nh5!∓ is fine for Black) 7...bxc5 8.Bb5!? (8.Bc4?! 0-0 9.0-0 d6∓) 8...Nd4!? (8...0-0 9.Bxc6 dxc6 10.0-0 Bg4 11.Re1 Nd7 12.h3 Bxf3 13.Qxf3±) 9.e5 Ng4 10.Nxd4 cxd4 11.Qxg4 dxc3∞** Black has a fully playable game [43, 44].
* After **6.Bc4 e6!** the bishop on c4 bites on granite! For example: **7.0-0 Nge7 8.d4?! (8.bxc5 bxc5 9.Rb1 is preferable) 8...cxd4 9.Nb5 0-0 10.Nbxd4 Nxd4 11.Nxd4 Bb7∓** Black had the better pawn structure, as well as the more harmonious development, in *Dobrov – Aroshidze*, Kavala 2004 [44, 45].

## Page 23

**6...e5!**

With the bishop on b2 this looks like the strategically correct move [45, 46].

* **6...cxb4 7.axb4 Nxb4 8.Bc4∞** [46].

**7.Bc4 Nge7 8.0-0 0-0 9.Nd5 d6=**

The computers are happy to be White here, which is difficult to understand as the b2-bishop is inactive. The position is approximately balanced: Black intends **...Rb8**, followed by **...b5** and/or a timely capture on d5 [46]. A sample line is:

**10.c3 Rb8 11.Ne3 h6 12.Ba2**
...
The computer finally agrees that Black stands well, and obviously his position is more pleasant from the human perspective in view of the protected passed pawn on b4 [46, 47].

---

### **Conclusion**

The 2nd move options examined in this chapter are not in any way theoretically dangerous for Black, but some may require careful memorization of details. Throughout the chapter, I tried to give sound recommendations without jeopardizing our winning chances, and I am particularly satisfied with the results. Overall, an engrossing chapter with many interesting ideas for Black, which I hope will enhance the readers' winning ways [47].
